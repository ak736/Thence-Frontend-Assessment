...
const Faqs = () => {
  return (
    <div className='mt-12 h-[500px] mx-6 my-4 rounded-3xl bg-[#E8EEE7] flex flex-row space-x-60'>
      {/* Left */}
      <div className='flex flex-col space-y-2 w-[700px]'>
        <div className='flex flex-col items-left pt-8 pl-16 gap-2'>
          <p className='font-grace font-regular text-xl text-[#9E9D9D]'>
            What’s on your mind{' '}
          </p>
          <p className='font-manrope font-semibold text-4xl'>Ask Questions</p>
        </div>
        <img src={union} className='h-[400px] w-[400px] pt-8 pr-4' alt='' />
      </div>
      {/* Right */}
